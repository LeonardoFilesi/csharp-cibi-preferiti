...
if(favFood.Length%2 == 1)
{
    ...
    Console.WriteLine("A metà della mia classifica di cibo c'è" + favFood[middleFood]);
}
else
{
    ...
    Console.WriteLine("A metà della mia classifica di cibo ci sono" + favFood[middleFood1] + "e" + favFood[middleFood2]);
}
